...
- Beim Scrollen (> 40 px): Hintergrund `rgba(42,50,51,.85)` + `backdrop-filter: blur(12px)`, top 0, Übergang 300 ms (Zustandsklasse `.is-scrolled`, gilt auch ohne Scroll-Kopplung).
